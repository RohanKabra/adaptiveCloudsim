...
public class DynamicScheduler extends AbstractWorkflowScheduler {
	...
	protected final double slowNodeThreshold = 0.5;
	...
	protected final double slowTaskThreshold = 0.5;
	...
	protected final double speculativeCap = 1.0;
	...
	public DynamicScheduler(String name, int taskSlotsPerVm) throws Exception {
